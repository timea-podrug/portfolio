...
function PortfolioWebsiteDetails() {
    return (
        ...
        <div className="portfolio_content">
            ...
            <iframe className="portfolio_video" width="560" height="265" src="https://www.youtube.com/embed/dAdb2X_GRxs?loop=1&autoplay=1&playlist=dAdb2X_GRxs" title="YouTube video player" frameborder="0" allow=" accelerometer; autoplay=1; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
